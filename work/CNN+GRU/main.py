...
test_flag = False
Data = Data_utility(r'C:\Users\CaiH\Desktop\work2-LST\train-valid-dataset\0606数据调整_电负荷.csv', 0.8, 0.18, 12, 7*96)
# Data = Data_utility(r'C:\Users\CaiH\Desktop\work2-LST\train-valid-dataset2\2020-24p-used.csv', 0.7, 0.2, 12, 7*24)
# one test one file
valid_path = "C:\\Users\\CaiH\\Desktop\\work2-LST\\CNN+GRU\\output\\valid.csv"
pred_path = "C:\\Users\\CaiH\\Desktop\\work2-LST\\CNN+GRU\\output\\pred.csv"

best_model_load_path = 'C:\\Users\\CaiH\\Desktop\\work2-LST\\CNN+GRU\\model\\saved_best_model.pth'
last_model_load_path = 'C:\\Users\\CaiH\\Desktop\\work2-LST\\CNN+GRU\\model\\saved_last_model.pth'
batch_size = 128
epoch_para = 30
learning_rate = 0.001
best_val = 10000000
...
for epoch in range(1, epoch_para + 1):
    ...
    train_loss = train(Data, Data.train[0], Data.train[1], model, criterion, batch_size)
